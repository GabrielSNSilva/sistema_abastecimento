<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <head>
            ...
            <title>Relatorio da represa</title>
        ...
        <body>
                ...
                <div id="main" class="container">
            		<h3 class="page-header">Relatorio ${represa.nome}</h3>
            		<div class="row">
                		<div class="col-md-6">
                    		<p><strong>ID</strong>
                    		</p>
            		...
            		<div class="row">
                		<div class="col-md-6">
                    		<p><strong>Volume da Reserva Técnica</strong>
                    		</p>
                    		<p>
            		...
            		<div class="row">
                		<div class="col-md-6">
                    		<p><strong>Volume armazenado</strong>
                    		</p>
                    		<p>
                        		${ represa.volumeArmazenado }
                    		</p>
                		</div>
            		</div>
            		<div class="row">
                		<div class="col-md-6">
                    		<p><strong>Pluviometria </strong>
                    		</p>
                    		<p>
                        		${ represa.pluviometria }
                    		</p>
                		</div>
            		</div>
            		<div class="row">
                		<div class="col-md-6">
                    		<p><strong>Volume total</strong>
                    		</p>
                    		<p>
                        		${ represa.volumeTotal }
                    		</p>

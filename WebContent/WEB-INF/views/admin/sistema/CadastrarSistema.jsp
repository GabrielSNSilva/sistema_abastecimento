...
<head>
    ...
    <title>Cadastrar Sistema de Abastecimento</title>
...
<body>
    ...
    <div id="main" class="container">
        <h3 class="page-header">Cadastrar Sistema de Abastecimento</h3>
        <!-- Formulario para inclusao de clientes -->
        <form action="novo_sistema" method="post">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <!-- <input type="text" class="form-control" name="localidade" id="localidade" required maxlength="100" placeholder="Localidade"> -->
